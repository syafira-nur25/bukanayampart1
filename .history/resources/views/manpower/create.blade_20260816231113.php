...
<div class="card border-0 shadow-sm">
    <div class="card-body p-4">
        ...
        <p class="text-muted small mb-4">Isi kondisi ayam dan produksi hari ini.</p>
        ...
        <form action="{{ route('manpower.laporan.store') }}" method="POST">
            ...
            <div class="row g-3">
                ...
                <div class="col-6">
                    ...
                    <input type="number" name="umur_minggu" class="form-control" value="{{ old('umur_minggu') }}" min="0" required>
                </div>
                <div class="col-6">
                    <label class="form-label">Populasi / Sisa Ayam</label>
                    <input type="number" name="sisa_ayam" class="form-control" value="{{ old('sisa_ayam') }}" min="0" required>
                </div>
                ...
                <div class="col-4">
                    ...
                    <input type="number" step="0.01" name="total_pakan" class="form-control" value="{{ old('total_pakan') }}" min="0" required>
                </div>
                <div class="col-4">
                    <label class="form-label">Telur Bagus</label>
                    <input type="number" name="produksi_telur" class="form-control" value="{{ old('produksi_telur', 0) }}" min="0" required>
                </div>
                <div class="col-4">
                    <label class="form-label">Telur Pecah/Reject</label>
                    <input type="number" name="telur_pecah" class="form-control" value="{{ old('telur_pecah', 0) }}" min="0" required>
                </div>
