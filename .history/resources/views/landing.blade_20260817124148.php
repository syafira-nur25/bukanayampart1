...
/* Garis pemisah antara logo perusahaan & logo peternakan */
.brand-divider{
  width: 1px;
  height: 32px;
...
<nav class="nav-landing" id="navLanding">
  <div class="container d-flex align-items-center justify-content-between">
    <a href="{{ url('/') }}" class="navbar-brand">
      {{-- Logo perusahaan — fallback ke ikon telur kalau file belum ada --}}
      <img src="{{ asset('logo.png') }}" alt="Logo Perusahaan" class="nav-logo"
           onerror="this.style.display='none'; this.nextElementSibling.style.display='inline-flex';">
      <span class="brand-fallback" style="display:none;"><i class="bi bi-egg-fried"></i></span>
