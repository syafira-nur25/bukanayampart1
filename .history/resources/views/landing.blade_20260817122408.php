...
.nav-landing .navbar-brand{font-weight:800;color:#fff;transition:transform .3s}
.nav-landing .nav-links a{color:rgba(255,255,255,.85);text-decoration:none;font-size:14px;font-weight:500;margin-left:22px;transition:color .2s}
.nav-landing .nav-links a:hover{color:#fff}

/* efek saat di-scroll */
.nav-landing.scrolled{
  background: rgba(45, 27, 22, 0.78);
...
.nav-landing.scrolled .navbar-brand{transform:scale(.95)}

.brand-egg{
  width:40px;height:40px;border-radius:10px;
  background:linear-gradient(135deg,var(--coklat-500),var(--coklat-400));
  display:inline-flex;align-items:center;justify-content:center;
  color:#ffe9c9;font-size:20px;margin-right:10px;
...
.btn-ghost{border:1px solid rgba(255,255,255,.5);color:#fff;padding:8px 18px}
...
/* telur-telur melayang (tetap ada) */
...
/* telur jatuh keluar dari ayam */
.ch-egg-drop{
  transform-origin:center;
  animation: eggDrop 3.5s ease-in infinite;
  opacity:0;
}
...
@keyframes eggDrop{
  ...
  15%{transform:translate(0,0) scale(.9);opacity:1}
  70%{transform:translate(-20px,120px) scale(1);opacity:1}
  90%{transform:translate(-25px,150px) scale(1.05);opacity:.7}
  100%{transform:translate(-30px,170px) scale(.8);opacity:0}
}
@keyframes grassSway{
...
<nav class="nav-landing" id="navLanding">
        ...
        <div class="stage">
          ...
          <div class="chicken-wrap">
            <svg viewBox="0 0 320 320" xmlns="http://www.w3.org/2000/svg">
              <!-- rumput -->
              <g class="grass">
                <path d="M40 290 Q60 270 80 290 Q100 270 120 290 Q140 270 160 290 Q180 270 200 290 Q220 270 240 290 Q260 270 280 290"
                      stroke="#5d8a4a" stroke-width="4" fill="none" stroke-linecap="round"/>
                <path d="M50 295 L50 280 M90 295 L90 278 M130 295 L130 282 M170 295 L170 278 M210 295 L210 280 M250 295 L250 278"
                      stroke="#6fa05a" stroke-width="2" stroke-linecap="round"/>
              </g>
              ...
              <g class="ch-body">
                <!-- ekor -->
                <g class="ch-tail">
                  <path d="M230 200 Q275 160 270 110 Q255 140 240 155 Q255 120 245 95 Q230 130 220 150 Q225 115 215 100 Q205 140 210 175 Z"
                        fill="#5d4037"/>
                ...
                <g class="ch-head">
                  ...
                  <!-- jengger -->
                  <g class="ch-comb">
                    <path d="M140 105 Q145 85 150 100 Q155 80 160 100 Q165 82 170 100 Q175 85 180 108 Q165 115 140 110 Z"
                          fill="#d93636"/>
                ...
                <!-- telur yang jatuh (muncul berkala) -->
                <g class="ch-egg-drop">
...
<script>
  // Navbar: tambah class 'scrolled' ketika user scroll ke bawah
