...
/* Fallback telur kalau logo tidak ada */
.brand-egg{
...
{{-- ===== ANIMASI KURSOR TELUR v2 (tidak nyangkut di pojok) ===== --}}
<style>
@media (pointer: fine) {
...
(function () {
  ...
  // mulai dari LUAR layar, biar tidak ada apa-apa di pojok
  ...
  // sembunyikan lagi saat kursor keluar dari halaman
