                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select name="kandang_id" class="form-select" required>
                        @foreach ($kandangs as $kandang)
                            <option value="{{ $kandang->id }}" @selected(old('kandang_id', $produksiTelur->kandang_id) == $kandang->id)>
                                {{ $kandang->nama }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select name="populasi_id" id="populasi_id" class="form-select" required>
                        @foreach ($populisis as $populasi)
                            <option value="{{ $populasi->id }}" @selected(old('populasi_id', $produksiTelur->populasi_id) == $populasi->id)>
