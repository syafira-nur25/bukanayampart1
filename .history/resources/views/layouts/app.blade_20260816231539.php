...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .brand-subtitle { font-size: 11px; color: #9fb8ad; }
        ...
        .icon-green { background: #d1e7dd; color: #146c43; }
        ...
        .table tbody td { font-size: 13px; border-color: #f0f1f2; }

        .badge-status { padding: 6px 10px; border-radius: 20px; font-size: 11px; font-weight: 600; }
        .badge-success { background: #d1e7dd; color: #146c43; }
...
<aside class="sidebar" id="sidebar">
    ...
    <div class="sidebar-content">
        ...
        @if ($isAdmin)
            ...
            <a href="{{ route('dashboard') }}" class="{{ request()->is('/') || request()->routeIs('dashboard') ? 'active' : '' }}">
        ...
        <div class="sidebar-footer">
            <form method="POST" action="{{ route('logout') }}">
                @csrf
                <button type="submit" class="btn-logout w-100 text-start d-flex align-items-center gap-2">
    ...
    <header class="topbar">
        ...
        <div class="profile">
            ...
            @else
                ...
                <div class="d-none d-md-block">
                    <div style="font-size:13px;font-weight:600;">Belum Login</div>
                </div>
            @endauth
        </div>
    </header>
