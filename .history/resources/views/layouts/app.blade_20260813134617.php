...
<div class="main">
    ...
    <main class="content">
        ...
        @if(auth()->check() && auth()->user()->role === 'manpower')
    ...
    <a
        href="{{ route('manpower.laporan.create') }}"
        class="{{ request()->is('manpower/laporan*') ? 'active' : '' }}"
    >
...
@if(auth()->check() && auth()->user()->role === 'admin')
    ...
    <a
        ...
        class="{{ request()->is('admin/laporan-harian*') ? 'active' : '' }}"
    >
        <i class="bi bi-clipboard-data-fill"></i>
        Laporan Man Power
    </a>
